    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                Text("Öncelik Dağılımı (Pasta Grafiği)")
                    .font(.headline)
                Spacer()
            }
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                Text("Ortalama Tamamlanma Süresi")
                    .font(.headline)
                Spacer()
            }
            ...
            HStack {
                VStack(alignment: .leading, spacing: 4) {
                    Text(String(format: "%.1f gün", avgTime))
                        .font(.system(size: 36, weight: .bold))
                        .foregroundColor(.primary)
