...
enum Priority: String, Codable, CaseIterable {
    ...
    var displayName: String {
        ...
        switch self {
        case .high: return localizationManager.localized("priority_high")
        case .medium: return localizationManager.localized("priority_medium")
        case .low: return localizationManager.localized("priority_low")
        }
    }
...
enum RecurrenceType: String, Codable, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .none: return LocalizationManager.shared.localized("recurrence_none")
        case .daily: return LocalizationManager.shared.localized("recurrence_daily")
        case .weekly: return LocalizationManager.shared.localized("recurrence_weekly")
        case .monthly: return LocalizationManager.shared.localized("recurrence_monthly")
        case .yearly: return LocalizationManager.shared.localized("recurrence_yearly")
        }
    }
}
